...
if(!function_exists("short_number_format")){
    ...
    function short_number_format($n) {
        // is this a number?
...
if(!function_exists("two_decimal_float")){

    function two_decimal_float($num){
...
if(!function_exists("convert_indian_currency_word")){

    function convert_indian_currency_word($number) {
        $no = round($number);
